  ...
  const {
    ...
    defaultValues: customer ? {
      ...
      usageFee: customer.usageFee ? {
        ...
        billingYears: customer.usageFee.billingYears || 0,
        area: customer.usageFee.area || '',
        unitPrice: customer.usageFee.unitPrice || 0,
        usageFee: customer.usageFee.usageFee || 0,
      ...
      managementFee: customer.managementFee ? {
        ...
        billingYears: customer.managementFee.billingYears || 0,
        area: customer.managementFee.area || '',
        billingMonth: customer.managementFee.billingMonth || 0,
        managementFee: customer.managementFee.managementFee || 0,
        unitPrice: customer.managementFee.unitPrice || 0,
