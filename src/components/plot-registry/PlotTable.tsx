              ...
              plots.map((plot, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className={cellWrapClass('areaName', 'px-2 py-3 text-xs text-hai')} title={plot.areaName || undefined}>
                    ...
                    <td className={cellWrapClass('address', 'px-2 py-3 text-xs text-hai hidden md:table-cell')} title={plot.customerAddress || undefined}>
                      {isColumnExpanded(columnWidths, 'address')
                        ? (plot.customerAddress || '-')
                        : truncateAddressToCity(plot.customerAddress)}
                    </td>
                    <td className={cellWrapClass('phone', 'px-2 py-3 text-xs text-hai hidden lg:table-cell tabular-nums')} title={plot.customerPhoneNumber || undefined}>
                      {formatPhoneNumber(plot.customerPhoneNumber) || '-'}
                    </td>
                    <td className={cellWrapClass('agent', 'px-2 py-3 text-xs text-hai hidden lg:table-cell')} title={plot.agentName || undefined}>
                      {plot.agentName || '-'}
                    </td>
                    <td className={cellWrapClass('permitNumber', 'px-2 py-3 text-xs text-hai tabular-nums hidden lg:table-cell')} title={plot.permitNumber || undefined}>
                      {plot.permitNumber || '-'}
                    </td>
                    ...
                    {showBuriedPersons && (
                      <td className={cellWrapClass('buriedPersons', 'px-2 py-3 text-xs text-hai hidden lg:table-cell')} title={plot.buriedPersonNames?.join(', ') || undefined}>
                    ...
                    <td className="px-2 py-3 text-xs text-hai truncate tabular-nums hidden md:table-cell" title={formatDate(plot.nextBillingDate) === '-' ? undefined : formatDate(plot.nextBillingDate)}>
