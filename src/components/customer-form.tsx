...
import { Customer, PLOT_UNIT_TYPE_LABELS, PLOT_STATUS_LABELS, OWNERSHIP_TYPE_LABELS, PLOT_SECTIONS_BY_PERIOD, PlotPeriod, OwnedPlot, PLOT_SIZE, PLOT_SIZE_LABELS, PlotSizeType, ConstructionRecord, ConstructionType, CONSTRUCTION_TYPE_LABELS, HistoryRecord, HistoryReasonType, HISTORY_REASON_LABELS } from '@/types/customer';
import { customerFormSchema, CustomerFormData } from '@/lib/validations';
import { Button } from '@/components/ui/button';
import { Input } from '@/components/ui/input';
import { Label } from '@/components/ui/label';
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@/components/ui/select';
import { formatDate, calculateEffectiveCapacity, calculateSuggestedPrice, getPlotArea, calculateOwnedPlotsInfo } from '@/lib/utils';
                  ...
                  <table className="w-full">
                    ...
                    <tbody>
                      {buriedPersonFields.map((field, index) => {
                        ...
                        const isExpanded = expandedContactId === `burial-${field.id}`;
                        ...
                        return (
                          <>
                            <tr
                              ...
                              onClick={() => setExpandedContactId(isExpanded ? null : `burial-${field.id}`)}
                            >
                              ...
                              <td className="px-4 py-2 text-center">
                                <Button
                                  ...
                                  onClick={(e) => {
                                    ...
                                    if (expandedContactId === `burial-${field.id}`) {
                                      setExpandedContactId(null);
                                    }
                                  }}
                                  className="text-red-600 hover:text-red-800 hover:bg-red-50"
...
// 区画設定セクション（複数区画管理対応）
interface PlotSettingsSectionProps {
  customer?: Customer;
  watch: ReturnType<typeof useForm<CustomerFormData>>['watch'];
  setValue: ReturnType<typeof useForm<CustomerFormData>>['setValue'];
}

function PlotSettingsSection({ customer, watch, setValue }: PlotSettingsSectionProps) {
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
          <div className="grid grid-cols-3 gap-4">
            <div>
              ...
              <div className="text-xl font-bold text-green-800">{plotsInfo.totalAreaSqm}㎡</div>
            </div>
            <div>
            ...
            <div key={plot.id} className="border rounded-lg p-4 bg-white shadow-sm">
              ...
              <div className="grid grid-cols-5 gap-4 text-sm">
                ...
                <div>
                  ...
                  <div className="font-medium">{plot.areaSqm}㎡</div>
                </div>
                <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="full">1区画（3.6㎡）</SelectItem>
                      <SelectItem value="half">半区画（1.8㎡）</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </div>
