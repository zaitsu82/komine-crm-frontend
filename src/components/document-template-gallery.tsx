...
const TEMPLATES: TemplateOption[] = [
  {
    ...
    color: 'text-kohaku-700',
    bgColor: 'bg-kohaku-50',
    borderColor: 'border-kohaku-200 hover:border-kohaku-400',
    hasTemplate: true,
  },
  {
    id: 'postcard',
    ...
    color: 'text-matsu-700',
    bgColor: 'bg-matsu-50',
    borderColor: 'border-matsu-200 hover:border-matsu-400',
    hasTemplate: true,
  },
  {
    id: 'contract',
    ...
    color: 'text-ai-700',
    bgColor: 'bg-ai-50',
    borderColor: 'border-ai-200 hover:border-ai-400',
    hasTemplate: false,
  },
  {
    id: 'permit',
    ...
    color: 'text-beni-700',
    bgColor: 'bg-beni-50',
    borderColor: 'border-beni-200 hover:border-beni-400',
    hasTemplate: false,
  },
  {
    id: 'other',
    ...
    color: 'text-cha-700',
    bgColor: 'bg-cha-50',
    borderColor: 'border-cha-200 hover:border-cha-400',
    hasTemplate: false,
  },
];
