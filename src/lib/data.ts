...
export function formDataToCustomer(formData: CustomerFormData): Omit<Customer, 'id' | 'createdAt' | 'updatedAt'> {
  ...
  return {
    ...
    usageFee: formData.usageFee && (
      ...
      billingYears: formData.usageFee.billingYears ? parseInt(formData.usageFee.billingYears, 10) : null,
      area: formData.usageFee.area || '',
      unitPrice: formData.usageFee.unitPrice ? parseInt(formData.usageFee.unitPrice, 10) : null,
      usageFee: formData.usageFee.usageFee ? parseInt(formData.usageFee.usageFee, 10) : null,
    ...
    managementFee: formData.managementFee && (
      ...
      billingYears: formData.managementFee.billingYears ? parseInt(formData.managementFee.billingYears, 10) : null,
      area: formData.managementFee.area || '',
      billingMonth: formData.managementFee.billingMonth ? parseInt(formData.managementFee.billingMonth, 10) : null,
      managementFee: formData.managementFee.managementFee ? parseInt(formData.managementFee.managementFee, 10) : null,
      unitPrice: formData.managementFee.unitPrice ? parseInt(formData.managementFee.unitPrice, 10) : null,
